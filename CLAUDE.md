...
- **`sotatek-smart-contracts/`** — alpha-launch contracts: stablecoins (RUSD/FYUSD/iRUSD), governance token (FYP), ERC-4626 cooldown vaults (sRUSD/stAUSD/siRUSD/sFYP), mint engine, burn queue, FYUSD epoch settlement, FYUSD yield vault, FYP emission staking hub, circuit breaker, settings registry. Deployed on Ethereum Sepolia (chainId 11155111) as of 2026-04-30 (migrated from BSC Testnet chainId 97). Address registry: `addresses/11155111.json`. **Default to working here.**
